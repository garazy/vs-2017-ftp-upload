...
namespace FTPUpload
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class FTPCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid ( "f8b84d2b-0232-49d5-9c5e-161b8129afe7" );
        ...
        private FTPCommand ( AsyncPackage package , OleMenuCommandService commandService )
        {
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in FTPCommand's constructor requires
            // the UI thread.
            ThreadHelper.ThrowIfNotOnUIThread ( );

            OleMenuCommandService commandService = await package.GetServiceAsync ( ( typeof ( IMenuCommandService ) ) ) as OleMenuCommandService;
            Instance = new FTPCommand ( package , commandService );
        }
